...
export const chillerMonitoringSchema: LogbookSchema = {
  ...
  fields: [
    ...
    {
      id: 'chiller_supply_temp',
      name: 'chiller_supply_temp',
      label: 'Chiller Supply Temp',
      type: 'number',
      required: true,
      placeholder: 'Enter temperature in °C',
      validation: {
        max: 8,
        customMessage: 'NMT 8 °C'
      },
      display: { order: 3, group: 'Temperature Readings', columnSpan: 1 },
      metadata: {
        limit: { type: 'max', value: 8, unit: '°C', condition: 'NMT' },
        highlightColor: 'red'
      }
    },
    {
      id: 'chiller_return_temp',
      name: 'chiller_return_temp',
      label: 'Chiller Return Temp',
      type: 'number',
      required: true,
      placeholder: 'Enter temperature in °C',
      validation: {
        max: 15,
        customMessage: 'NMT 15 °C'
      },
      display: { order: 4, group: 'Temperature Readings', columnSpan: 1 },
      metadata: {
        limit: { type: 'max', value: 15, unit: '°C', condition: 'NMT' },
        highlightColor: 'red'
      }
    },
    {
      id: 'cooling_tower_supply_temp',
      name: 'cooling_tower_supply_temp',
      label: 'Cooling Tower Supply Temp',
      type: 'number',
      required: true,
      placeholder: 'Enter temperature in °C',
      validation: {
        max: 25,
        customMessage: 'NMT 25 °C'
      },
      display: { order: 5, group: 'Temperature Readings', columnSpan: 1 },
      metadata: {
        limit: { type: 'max', value: 25, unit: '°C', condition: 'NMT' },
        highlightColor: 'red'
      }
    },
    {
      id: 'cooling_tower_return_temp',
      name: 'cooling_tower_return_temp',
      label: 'Cooling Tower Return Temp',
      type: 'number',
      required: true,
      placeholder: 'Enter temperature in °C',
      validation: {
        max: 30,
        customMessage: 'NMT 30 °C'
      },
      display: { order: 6, group: 'Temperature Readings', columnSpan: 1 },
      metadata: {
        limit: { type: 'max', value: 30, unit: '°C', condition: 'NMT' },
        highlightColor: 'red'
      }
    },
    {
      id: 'ct_differential_temp',
      name: 'ct_differential_temp',
      label: 'CT Differential Temperature',
      type: 'number',
      required: true,
      placeholder: 'Enter temperature in °C',
      validation: {
        max: 5,
        customMessage: 'NMT 5 °C'
      },
      display: { order: 7, group: 'Temperature Readings', columnSpan: 1 },
      metadata: {
        limit: { type: 'max', value: 5, unit: '°C', condition: 'NMT' },
        highlightColor: 'red'
      }
    },
    {
      id: 'chiller_water_inlet_pressure',
      name: 'chiller_water_inlet_pressure',
      label: 'Chiller Water Inlet Pressure',
      type: 'number',
      required: true,
      placeholder: 'Enter pressure in bar',
      validation: {
        min: 2,
        customMessage: 'NLT 2 bar'
      },
      display: { order: 8, group: 'Pressure Readings', columnSpan: 1 },
      metadata: {
        limit: { type: 'min', value: 2, unit: 'bar', condition: 'NLT' },
        highlightColor: 'red'
      }
    },
    {
      id: 'chiller_makeup_water_flow',
      name: 'chiller_makeup_water_flow',
      label: 'Chiller Make Up Water Flow',
      type: 'number',
      required: true,
      placeholder: 'Enter flow in LPH',
      display: { order: 9, group: 'Flow Readings', columnSpan: 1 }
    },
    {
      id: 'remarks',
      name: 'remarks',
